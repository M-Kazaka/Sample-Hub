...
function SplashPage() {
    ...
    const toggleImage = () => {
        setImage(currentImage => currentImage === dayImage ? nightImage : dayImage);
    }
  return (
    <>
      <div className="App">
      <button onClick={toggleImage}>
        ...
        <header className="App-header">
          <img src={image} className="img-fluid" alt="imageSwitch" />

          <h5 className="intro">
            Talofa!! Welcome to my portfolio. Everything here is just a WIP.
            When I have a creative itch I come here to flex it. Enjoy your stay.
            Drop suggestions or comments on my work.
          </h5>
        </header>
